...
export const TYPES = {
  cheoneul: {
    name: '하늘이 붙여준 사람', short: '천을귀인', grade: 'S', color: '#c9a227',
    in: '살면서 몇 번 만나기 어려운 자리입니다. 이 사람이 있는 방향에서 일이 풀립니다.',
    out: '당신이 이 사람에게 그런 자리입니다. 별일 안 해도 이 사람의 일이 풀립니다.',
    how: '급할 때 제일 먼저 연락할 사람으로 저장해 두세요.',
  },
  jeongin: {
    name: '든든한 우산', short: '정인', grade: 'A', color: '#3d8b6d',
    in: '비가 올 때 말없이 펴주는 쪽입니다. 받기만 하기 쉬워서 미안해지는 관계입니다.',
    out: '당신이 이 사람의 우산입니다. 이 사람은 당신 앞에서 긴장이 풀립니다.',
    how: '조언을 구하면 아깝지 않게 내어줍니다. 물어보는 걸 아끼지 마세요.',
  },
  pyeonin: {
    name: '조용한 참모', short: '편인', grade: 'B', color: '#5a8f7b',
    in: '앞에 나서진 않는데 결정적인 순간에 한마디를 보탭니다. 그 한마디가 방향을 바꿉니다.',
    out: '당신의 한마디가 이 사람의 판단을 바꿉니다. 말을 아껴서 더 무겁게 쓰세요.',
    how: '자주 볼 필요는 없습니다. 막힐 때만 찾아도 되는 사이입니다.',
  },
  jeonggwan: {
    name: '나를 세우는 사람', short: '정관', grade: 'A', color: '#4a6fa5',
    in: '느슨해질 때 자세를 고쳐 앉게 만듭니다. 편하진 않아도 이 사람 앞에서 사람 구실을 합니다.',
    out: '당신이 이 사람의 기준입니다. 당신이 흐트러지면 이 사람도 흐트러집니다.',
    how: '약속을 잘 지키는 걸로 신뢰가 쌓이는 관계입니다.',
  },
  pyeongwan: {
    name: '나를 흔드는 사람', short: '편관', grade: 'C', color: '#6b5b95',
    in: '긴장을 줍니다. 피곤한데 이상하게 이 사람 있을 때 실력이 나옵니다.',
    out: '당신이 이 사람을 긴장시킵니다. 세게 말하면 진짜로 아파하니 수위를 보세요.',
    how: '길게 붙어 있기보다 짧고 굵게 만나는 게 서로에게 낫습니다.',
  },
  jeongjae: {
    name: '손발이 맞는 사람', short: '정재', grade: 'A', color: '#b5793a',
    in: '말 안 해도 다음 순서를 압니다. 같이 뭘 벌이면 실제로 굴러가는 조합입니다.',
    out: '당신이 판을 깔면 이 사람이 채웁니다. 역할만 나눠주면 알아서 합니다.',
    how: '같이 일 벌이기 좋은 사이. 다만 돈 얘기는 처음에 명확히.',
  },
  pyeonjae: {
    name: '판을 키우는 사람', short: '편재', grade: 'B', color: '#c98b3a',
    in: '작게 갈 일을 크게 만듭니다. 재미있지만 뒷정리는 각오해야 합니다.',
    out: '당신이 이 사람의 판을 키웁니다. 신나게 만들되 마무리는 챙겨주세요.',
    how: '새로운 걸 시작할 때 부르면 좋은 사람입니다.',
  },
  siksin: {
    name: '나를 웃게 하는 사람', short: '식신', grade: 'A', color: '#d98b8b',
    in: '같이 있으면 잘 먹고 잘 웃습니다. 특별한 이유 없이 기분이 나아지는 쪽입니다.',
    out: '당신이 이 사람을 편하게 만듭니다. 이 사람은 당신 앞에서 잘 웃습니다.',
    how: '용건 없이 만나는 게 제일 잘 맞는 사이입니다.',
  },
  sanggwan: {
    name: '나를 튀게 하는 사람', short: '상관', grade: 'B', color: '#d96b9c',
    in: '가만있던 사람을 끌어냅니다. 덕분에 판이 커지지만 가끔 수습이 필요합니다.',
    out: '당신이 이 사람의 스위치입니다. 부추기면 진짜로 저지릅니다.',
    how: '아이디어 회의에 부르면 최고, 마무리는 다른 사람에게.',
  },
  bigyeon: {
    name: '거울 같은 사람', short: '비견', grade: 'B', color: '#7a8b99',
    in: '설명이 필요 없습니다. 똑같아서 편하고, 똑같아서 가끔 답답합니다.',
    out: '당신을 보는 것 같다고 느낍니다. 그래서 숨기기가 어렵습니다.',
    how: '고민 상담에 최적. 단, 둘 다 같은 함정에 빠질 수 있으니 조심.',
  },
  geopjae: {
    name: '나를 자극하는 사람', short: '겁재', grade: 'C', color: '#8b7a99',
    in: '비슷한데 미묘하게 다릅니다. 자극이 되지만 같은 걸 두고 겹칠 때가 있습니다.',
    out: '이 사람은 당신을 의식합니다. 챙겨주면 든든한 편이 됩니다.',
    how: '경쟁 구도만 피하면 가장 오래 가는 사이가 됩니다.',
  },
  chungdol: {
    name: '롤러코스터', short: '충', grade: 'C', color: '#c05353',
    in: '조용할 틈이 없습니다. 좋을 땐 아주 좋고 틀어질 땐 확실히 틀어집니다.',
