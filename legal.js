...
<li>하나의 지도에 참여할 수 있는 인원에 제한을 두지 않습니다. 다만 서버 보호를 위해 지도 하나당 최대 300명까지만 기록합니다.</li>
<li>서비스 운영에는 후원과 광고가 쓰일 수 있습니다. 후원 여부는 서비스 이용에 어떤 차이도 만들지 않습니다.</li>
<li>유료 기능이 도입되는 경우 사전에 공지하며, 그 전까지 만들어진 지도는 그대로 유지됩니다.</li>
</ul>
