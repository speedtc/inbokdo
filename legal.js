...
<tr><td>필수</td><td>이름 또는 닉네임, 성별, 생년월일, 태어난 시각(선택), 양력·음력 구분</td><td>이용자 직접 입력</td></tr>
...
<p>서비스는 이메일 주소, 전화번호, 주소, 결제 정보를 수집하지 않습니다. 생년월일과 성별은 <b>이용자의 브라우저(localStorage)에 저장</b>되며, 지도나 방에 참여할 때를 제외하면 서버로 전송되지 않습니다.</p>

<h2>2. 이용 목적</h2>
<ul>
<li>입력한 생년월일시를 사주(四柱)로 환산하여 두 사람 사이의 관계를 분석</li>
<li>성별은 대운(大運)의 순행·역행 방향과 배우자·자녀 자리 판정에 사용합니다. 명리학에서 이 두 가지는 남녀가 반대로 계산되어, 성별 없이는 결과가 달라집니다.</li>
...
<h2>4. 제3자 제공</h2>
<p>서비스는 이용자의 개인정보를 제3자에게 제공하지 않습니다. 다른 참여자에게는 <b>이름(닉네임), 궁합 점수, 관계 유형, 일간 캐릭터</b>만 표시되며 <b>생년월일·태어난 시각·성별은 지도 주인을 포함한 누구에게도 공개되지 않습니다.</b></p>
